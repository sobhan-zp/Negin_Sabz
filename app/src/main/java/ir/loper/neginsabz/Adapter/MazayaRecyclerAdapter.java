...
public class MazayaRecyclerAdapter extends RecyclerView.Adapter<MazayaRecyclerAdapter.MyViewHolder> {

    private List<MazayaModel> itemList;
    ...
    public MazayaRecyclerAdapter(Context context, List<MazayaModel> itemList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_item_mazaya, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        final MazayaModel Item = itemList.get(position);
